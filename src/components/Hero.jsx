    ...
    <section style={{ padding: "8rem 0 6rem", textAlign: "center" }}>
      <div className="container">
        <div style={{ marginBottom: "2rem" }}>
          ...
          >
            Modele : Securite des applications mobiles
          </span>
          <p style={{ color: "var(--text-secondary)", fontSize: "1rem", margin: 0, fontWeight: 500 }}>
            Ecole Nationale des Science Appliquees <span style={{ opacity: 0.5, margin: "0 0.75rem" }}>|</span> Pr. Mohamed LACHGAR
          </p>
        </div>
        <h1
        ...
        >
          Securite des<br />Applications Mobiles
        </h1>
